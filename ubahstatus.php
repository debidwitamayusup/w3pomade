...
$result = mysqli_query($mysqli, "SELECT * FROM keranjang WHERE idKeranjang='$idKeranjang'");
	...
	<form name="form1" method="post" action="a_checkout.php">
		<table border="0">
			<tr> 
				...
				<td><input class="form-control" type="text" name="a_checkout" value="<?php echo $status;?>"></td>
			</tr>
			<tr>
