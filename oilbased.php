...
$result = mysqli_query($mysqli, "SELECT * FROM produk WHERE kategori = 'oilbased'");
            ...
            echo "<div id=\"sub-brdetail\" style=\"\">
					 ...
					 echo "<h3> $dt[deskripsi6]</h3>";	 
                        ...
                        if(!isset($_SESSION['valid'])) {
                           echo "<form  method=\"POST\" action=\"loginoilbased.php?eksen=adaProduk&p=detProduk&idProduk=$dt[idProduk]\">";
