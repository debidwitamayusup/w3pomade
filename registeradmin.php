...
if(isset($_POST['submit'])) {
	...
	if($idAdmin == "" || $nama == "" || $telp == "" || $alamat == "" || $email == "" || $username == ""	||	$pass == "") {
		echo "<div id='account-form'>";
		echo "<div class='alert alert-danger'>Semua field harus diisi. Beberapa field ditemukan kosong.</div>";
		echo "<br/>";
		echo "<a href='registeradmin.php'>Kembali</a>";
		echo "</div>";
	} else {
		mysqli_query($mysqli, "INSERT INTO admin(idAdmin, nama, telp, alamat, email, username, password) VALUES('$idAdmin', '$nama', '$telp', '$alamat', '$email', '$username', md5('$pass'))")
...
//		echo "</div>";
    	...
    	echo "<div class=\"window\">";
        	echo "<a href=\"loginadmin.php\" class=\"close-button\" title=\"Close\">X</a>";
...
?>
	...
	<form name="form1" method="post" action="">
		...
		<input type="text" placeholder="ID Admin" name="idAdmin">
		
		<label><b>Nama<b></label>
		<input type="text" placeholder="Masukkan Nama" name="nama">
		
		<label><b>No. Telepon</b></label>
		<input type="text" placeholder="No. Telp Harus diisi" name="telp" required>
